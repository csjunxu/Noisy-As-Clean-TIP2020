        ...
        for aug in range(len(img_noisy_torch)):
            ...
            if SAVE_DURING_TRAINING and i % save_every == 0:
                ...
                with torch.no_grad():
                    ...
                    test_do_i_learned_noise = torch_to_np(img_noisy_torch[aug]) - net(img_noisy_torch[aug])
...
output_dir = 'E:/JunXu/NAC_TPAMI/results/set12_g_resnet_Aug_Epoch=1000/'
