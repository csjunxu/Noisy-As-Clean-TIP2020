...
def closure():
    ...
    for idx in range(len(net_input)):
        ...
        xn_name_5 = f'{files_name[:-4]}_{TEST_PLAN[0] * 255}'
        save_image(xn_name_5, np.clip(img_noisy_np_.transpose(2, 0, 1), 0, 1), output_path="./")
        xnn_name_5 = f'{files_name[:-4]}_{TEST_PLAN[0] * 255}'
        save_image(xnn_name_5, np.clip(img_noisy_noisy_np_.transpose(2, 0, 1), 0, 1), output_path="./")
    ...
    if i % 10 == 0:
        ...
        if psnr_2_5_max==0:
            ...
            final_ssim_max_5 = final_ssim_5
            SAVE_MODEL_FLAG = True
            tmp_name_p_5 = f'{files_name[:-4]}_{TEST_PLAN[0]*255}_{psnr_2_5:.2f}_final_{final_ssim_5:.4f}'
        ...
        if psnr_2_10_max == 0:
            ...
            final_ssim_max_10 = final_ssim_10
            SAVE_MODEL_FLAG = True
            tmp_name_p_10 = f'{files_name[:-4]}_{TEST_PLAN[1]*255}_{psnr_2_10:.2f}_final_{final_ssim_10:.4f}'
        ...
        if psnr_2_15_max == 0:
            ...
            final_ssim_max_15 = final_ssim_15
            SAVE_MODEL_FLAG = True
            tmp_name_p_15 = f'{files_name[:-4]}_{TEST_PLAN[2]*255}_{psnr_2_15:.2f}_final_{final_ssim_15:.4f}'
        ...
        if psnr_2_20_max == 0:
            ...
            final_ssim_max_20 = final_ssim_20
            SAVE_MODEL_FLAG = True
            tmp_name_p_20 = f'{files_name[:-4]}_{TEST_PLAN[3]*255}_{psnr_2_20:.2f}_final_{final_ssim_20:.4f}'
        ...
        if psnr_2_25_max == 0:
            ...
            final_ssim_max_25 = final_ssim_25
            SAVE_MODEL_FLAG = True
            tmp_name_p_25 = f'{files_name[:-4]}_{TEST_PLAN[4]*255}_{psnr_2_25:.2f}_final_{final_ssim_25:.4f}'
...
output_dir = 'E:/JunXu/NAC_TPAMI/results/bsd68_g_resnet_blind55_Aug_LR=0.001_Epoch=1000/'
...
for index in range(len(files)):
    ...
    test_np_list = []
    test_torch_list = []
    if files_name.endswith('066.png'):
        ...
        show_every = 1
        exp_weight = 0.99
        num_iter_plan = [1001] # previously 2001
        figsize = 4
