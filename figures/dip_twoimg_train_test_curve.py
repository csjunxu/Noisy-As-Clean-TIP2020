...
file_dir = 'dip_set12_L2_g_15_curve.pickle'
with open(file_dir, 'rb') as f:
    data_our = pickle.load(f)

file_name = data_our['files_name_record']
psnr_list = data_our['psnr_sm_record']
ssim_list = data_our['ssim_sm_record']
loss_list = data_our['training_loss_record']

psnr_1 = psnr_list[0:10001]
psnr_2 = psnr_list[10001:]

loss_1 = loss_list[0:10001]
loss_2 = loss_list[10001:]

ssim_1 = ssim_list[0:10001]
ssim_2 = ssim_list[10001:]


assert len(psnr_1) == len(loss_1)
assert len(psnr_2) == len(loss_2)
...
fig.savefig('DIP_twoimgs_train_test_curves_no_ssim3.pdf')
